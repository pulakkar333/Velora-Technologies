...
export default function Features() {
  const featureItems = [
    {
      ...
      icon: (
        <svg className="fill-indigo-400 group-hover:fill-indigo-300 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" width={24} height={24}>
  ...
  return (
    <section className="relative overflow-hidden py-16 md:py-24">
      ...
      <div className="pointer-events-none absolute left-1/2 top-0 -z-10 -mt-20 -translate-x-1/2 select-none" aria-hidden="true">
        <Image className="max-w-none opacity-75" src={BlurredShapeGray} width={760} height={668} alt="" priority />
      </div>
      <div className="pointer-events-none absolute bottom-0 left-1/2 -z-10 -mb-80 -translate-x-[120%] opacity-35 select-none" aria-hidden="true">
        ...
        <div className="border-t border-gray-800/60 pt-12 md:pt-20">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-16">
            ...
            <p className="mx-auto max-w-2xl text-lg text-indigo-200/65 leading-relaxed">
              Open AI reads and understands your files with nothing more than a single line of feedback, powering your workflow further than the speed of thought.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full relative mb-16 md:mb-24 flex justify-center" data-aos="fade-up">
        <Image
